...
| 기본 모델 | `qwen3:4b` | `mlx-community/gemma-3n-E4B-it-4bit` |
...
최초 다운로드는 HuggingFace에서 ~4.4GB를 가져옵니다. 네트워크에 따라 2~5분 소요.
...
| `MLX_MODEL` | `mlx-community/gemma-3n-E4B-it-4bit` | 기본 모델 |
